...
public class MiniProject extends Activity implements OnVareSelectedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// init db
		// DroidListDatabaseHelper dbh = new
		// DroidListDatabaseHelper(getApplicationContext());
		...
		Tab tabVareListe = ab
				...
				.setTabListener(
						new DroidListTabListener<VareListeFragment>(this,
								"vareliste", VareListeFragment.class));

		ab.addTab(tabVareListe);

		Tab tabShoppingListe = ab
				.newTab()
				.setText(R.string.shoppingliste_tab)
				// .setTabListener(new DroidListTabListener<FragmentTest>(this,
				// "shoppingliste", FragmentTest.class));
				.setTabListener(
						new DroidListTabListener<ShoppingListeFragment>(this,
								"shoppingliste", ShoppingListeFragment.class));

		ab.addTab(tabShoppingListe);
	}

	/*
	 * Ikke test kald til storeData (non-Javadoc)
	 * 
	...
	protected void onStop() {
		...
		super.onStop();
		Service.storeData(this, currShoppingList);
	}
	...
	public void onVareSelected(int position, Vare vare) {
		// ShoppingListeFragment slf =
		// (ShoppingListeFragment)getFragmentManager().findFragmentById(R.id.shoppingListe);
